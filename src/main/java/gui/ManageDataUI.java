...
public class manageDataUI extends javax.swing.JFrame {
    ...
    private void insertAreasBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_insertCountryBtnActionPerformed

        AppDatabase loadData = new AppDatabase();
        loadData.updateAreas();
    ...
    private void insertCategoriesBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_insertDataBtnActionPerformed


        AppDatabase loadData = new AppDatabase();
        loadData.updateCategories();

        JOptionPane.showMessageDialog(null, "Η εισαγωγή δεδομένων Κατηγοριών ολοκληρώθηκε επιτυχώς!",
                "ΕΙΣΑΓΩΓΗ", JOptionPane.INFORMATION_MESSAGE);
    }//GEN-LAST:event_insertDataBtnActionPerformed


    private void showAreaMenuBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_showCountryMenuBtnActionPerformed
        // TODO add your handling code here:
        new showAreaMenuUI().setVisible(true);
        dispose();
